...
3. [NANO](#nano)
4. [REAL TIME CLOCK (RTC)](#real-time-clock-rtc)
5. [THERMISTOR/RESISTIVE CHANNELS](#thermistorresistive-channels)
6. [I2C COMMUNICATION](#i2c-communication)
7. [ANALOG MEASUREMENT SUBCIRCUIT](#analog-measurement-subcircuit)
8. [CONTROL SIGNAL](#control-signal)
9. [COMMENTS](#comments)

## GENERAL

- This document refers to the Resistance Data Logger (RDL) system associated with the Jericho RDL PCB revision E4. This board is the successor of revision E1 (prototype).
