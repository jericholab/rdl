...
Vcc=3.3 %V %reference voltage of the ADC (external reference) (which also reduces the ADC range to 0-3.3V.
...
% Then transform the rest of the code to call this new matrix
