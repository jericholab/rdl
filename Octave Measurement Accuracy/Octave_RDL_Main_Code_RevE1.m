...
bit=12 %Number of bit for the Arduino Analog-to-Digital Converter (ADC) (e.g. 10-bit ADC)
bits=2^bit % Number of values possible with the given ADC
Vcc=3.3 %V %reference voltage of the ADC (external reference)
Rs= 4700 %ohm  %electrical resistance nominal value of series resistance in voltage divider circuit
