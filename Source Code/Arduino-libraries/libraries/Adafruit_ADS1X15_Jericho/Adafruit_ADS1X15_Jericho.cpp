/**************************************************************************/
/*!
    @file     Adafruit_ADS1X15_Jericho.cpp
...
*/
/**************************************************************************/
#include "Adafruit_ADS1X15_Jericho.h"
...
*/
/**************************************************************************/
bool Adafruit_ADS1X15_Jericho::begin(uint8_t i2c_addr, TwoWire *wire) {
  m_i2c_dev = new Adafruit_I2CDevice_Jericho(i2c_addr, wire);
...
/*!
    ...
    @param i2c_addr I2C address of device
    @param wire I2C bus
    @param desiredClk Desired initialisation clock speed

    @return true if successful, otherwise false
*/
/**************************************************************************/
bool Adafruit_ADS1X15_Jericho::beginWithClockSpeed(uint8_t i2c_addr, TwoWire *wire, uint32_t desiredClk) {
  m_i2c_dev = new Adafruit_I2CDevice_Jericho(i2c_addr, wire);
  return m_i2c_dev->beginWithClockSpeed(desiredClk);
}
...
*/
/**************************************************************************/
void Adafruit_ADS1X15_Jericho::setGain(adsGain_t gain) { m_gain = gain; }
...
*/
/**************************************************************************/
adsGain_t Adafruit_ADS1X15_Jericho::getGain() { return m_gain; }
...
*/
/**************************************************************************/
void Adafruit_ADS1X15_Jericho::setDataRate(uint16_t rate) { m_dataRate = rate; }
...
*/
/**************************************************************************/
uint16_t Adafruit_ADS1X15_Jericho::getDataRate() { return m_dataRate; }
...
*/
/**************************************************************************/
int16_t Adafruit_ADS1X15_Jericho::readADC_SingleEnded(uint8_t channel) {
  if (channel > 3) {
    return 0;
  }
...
*/
/**************************************************************************/
int16_t Adafruit_ADS1X15_Jericho::readADC_Differential_0_1() {
...
*/
/**************************************************************************/
int16_t Adafruit_ADS1X15_Jericho::readADC_Differential_0_3() {
...
*/
/**************************************************************************/
int16_t Adafruit_ADS1X15_Jericho::readADC_Differential_1_3() {
...
*/
/**************************************************************************/
int16_t Adafruit_ADS1X15_Jericho::readADC_Differential_2_3() {
...
*/
/**************************************************************************/
void Adafruit_ADS1X15_Jericho::startComparator_SingleEnded(uint8_t channel,
                                                   int16_t threshold) {
...
*/
/**************************************************************************/
int16_t Adafruit_ADS1X15_Jericho::getLastConversionResults() {
  // Read the conversion results
...
*/
/**************************************************************************/
float Adafruit_ADS1X15_Jericho::computeVolts(int16_t counts) {
...
*/
/**************************************************************************/
void Adafruit_ADS1X15_Jericho::startADCReading(uint16_t mux, bool continuous) {
  // Start with default values
  uint16_t config =
...
*/
/**************************************************************************/
bool Adafruit_ADS1X15_Jericho::conversionComplete() {
...
*/
/**************************************************************************/
void Adafruit_ADS1X15_Jericho::writeRegister(uint8_t reg, uint16_t value) {
  buffer[0] = reg;
  buffer[1] = value >> 8;
  buffer[2] = value & 0xFF;
...
*/
/**************************************************************************/
uint16_t Adafruit_ADS1X15_Jericho::readRegister(uint8_t reg) {
  buffer[0] = reg;
