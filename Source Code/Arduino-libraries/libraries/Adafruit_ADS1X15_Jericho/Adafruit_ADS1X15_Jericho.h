/**************************************************************************/
/*!
    @file     Adafruit_ADS1X15_Jericho.h
...
#include <Adafruit_I2CDevice_Jericho.h>
#include <Arduino.h>
#include <Wire.h>
...
*/
/**************************************************************************/
class Adafruit_ADS1X15_Jericho {
protected:
  // Instance-specific properties
  Adafruit_I2CDevice_Jericho *m_i2c_dev; ///< I2C bus device
...
public:
  ...
  bool beginWithClockSpeed(uint8_t i2c_addr = ADS1X15_ADDRESS, TwoWire *wire = &Wire, uint32_t desiredClk = 31000);
...
*/
/**************************************************************************/
class Adafruit_ADS1015 : public Adafruit_ADS1X15_Jericho {
public:
  Adafruit_ADS1015();
};
...
*/
/**************************************************************************/
class Adafruit_ADS1115 : public Adafruit_ADS1X15_Jericho {
public:
  Adafruit_ADS1115();
};
