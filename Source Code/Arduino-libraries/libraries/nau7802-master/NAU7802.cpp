...
float NAU7802::readmV(){
  ...
  //return (_avcc/(float)8388608)*(float)readADC() +(_avcc/2);   //necessary since the 24-bit cover the positive and negative range (-AVCC to +AVCC)
  //return (_avcc/(float)8388608)*(float)readADC();   //necessary since the 24-bit cover the positive and negative range (-AVCC to +AVCC)
