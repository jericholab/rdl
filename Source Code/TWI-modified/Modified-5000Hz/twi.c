/*
  ...
  Customized version by Jericho Lab to implement a slow I2C bus clock speed (5000Hz).
...
void twi_init(void)
{
  ...
  cbi(TWSR, TWPS0);
  cbi(TWSR, TWPS1);
  //TWBR = ((F_CPU / TWI_FREQ) - 16) / 2;  /// JERICHO MODIFICATION ///
  TWBR=25;   ///255 /// JERICHO MODIFICATION ///
  TWSR |= bit (TWPS0); /// JERICHO MODIFICATION ///
  TWSR |= bit (TWPS1); /// JERICHO MODIFICATION ///
